class UI {
    constructor() {
        ...
        this.itemDate = $("#expenseDate");
        this.itemPrice = $("#expensePrice");
    ...
    submitExpenseList() {
        ...
        //const expenseDate = this.expenseDate.val();
        ...
        if(expenseItem === '' || expensePrice === '' || expensePrice < 0) {
            ...
            //this.db(expense);
            console.log("die item id " + this.itemID);
    ...
    addExpense(expense){
        ...
        divElement.innerHTML = `<h3 id="expenseDate" >${date}</h3><h3 id="expensePrice" >-${expense.price}€</h3><h3 id="expenseItem">${expense.title}</h3>`;
